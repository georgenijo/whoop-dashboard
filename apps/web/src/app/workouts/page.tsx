...
import WorkoutsHero from "@/components/workouts/atelier/WorkoutsHero";
import Logbook from "@/components/workouts/atelier/Logbook";
import SportDonut from "@/components/workouts/atelier/SportDonut";
...
export default function WorkoutsPage() {
  ...
  return (
    <>
      <div className="classic-workouts">
