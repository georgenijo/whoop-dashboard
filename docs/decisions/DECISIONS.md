...
**References:** #273, #263 (audit + decision comments, 2026-08-16/17), #521, `apps/web/src/app/api/whoop/refresh/route.ts`, `apps/web/src/proxy.ts`, `apps/web/src/lib/whoop/token.ts`, `systemd/whoop-web-refresh.service`, `systemd/whoop-web-refresh.timer`, `docs/operations/environment-and-deploy.md` (install procedure)
